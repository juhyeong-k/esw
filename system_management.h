...
#define SIDE_DIRECTION_THRESHOLD		30 //90%
#define SIDE_DIRECTION_SIDE_UP			109 //90%
#define SIDE_DIRECTION_SIDE_DOWN		159 //90%

#define ISROADCLOSE_WIDTH				10
#define ISROADCLOSE_DISTANCE			20
#define ISROADCLOSE_THRESHOLD			30